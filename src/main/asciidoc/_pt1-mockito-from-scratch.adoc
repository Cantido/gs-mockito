...
Imagine if you had an object like this:
...
And imagine that another class of yours used this object.
You don’t want to worry about what kind of plumbing this object has.
You just want something to pass around in the class that you actually care about.
To create a mock of this object, you call the method `Mockito.mock()`:
